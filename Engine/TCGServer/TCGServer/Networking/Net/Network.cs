...
namespace TCGServer.Networking.Net
{
    public class Network : INetwork
    {
        ...
        private void AcceptCallBack(IAsyncResult ar) {
            ...
            Data.DataManager.User.Add(new Data.Models.Account());
        ...
        private void ReceiveCallBack(IAsyncResult ar) {
            ...
            try {
                ...
                Data.DataManager.SaveUserAccount(index);
                client.Disconnect();
            }
            ...
            if (length > 0) {
                NetworkManager.PacketManager.HandlePacket(index, client.Buffer);
            }
        ...
        public void SendDataTo(int index, byte[] array) {
            ...
            if (client.IsReceiving) {
                Program.Write("Wait packet initialized for user " + index + ".");
        ...
        public bool isConnected(int index) {
            if (index >= _client.Count) {
                return false;
            }
            return _client[index].Connected;
        }
    }
}
